  ...
  if (isUserLoading) {
    return (
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", background: "#f8fafc" }}>
        <div style={{ width: "40px", height: "40px", border: "4px solid #e2e8f0", borderTopColor: "#10b981", borderRadius: "50%", animation: "spin 1s linear infinite" }}></div>
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>สวัสดีครับคุณ {profile?.displayName} <br/>มาร่วมเป็นส่วนหนึ่งของ GreenShare กันนะครับ</p>
        </div>
