...
export const schemas = {
  ...
  notify_circle_members: z.object({ circle_id: id }).passthrough(),
  ...
  remove_empty_hand: z.object({ circle_id: id, hand_no: posInt }).passthrough(),

  // --- Cross-house membership ---
  request_join_house: z.object({ house_code: z.string().min(1) }).passthrough(),
  get_my_houses: z.object({}).passthrough(),
  generate_house_invite: z.object({}).passthrough(),
