...
export async function getCircles(data) {
  try {
    ...
    if (member.role === 'SUPERADMIN') {
      // SUPERADMIN sees:
      // 1. Circles from their own house (they created)
      // 2. Circles from houses they joined as an ACTIVE member
      // 3. Any circle they personally joined as a player
      ...
      console.log('[getCircles SUPERADMIN]', {
        memberId: member.id,
        allowedCreatorIds: Array.from(allowedCreatorIds),
        joinedCircleIds: Array.from(joinedSet),
      });
